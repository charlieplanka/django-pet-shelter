...
UNSAFE_DEFAULT_SECRET_KEY = '0#*rrb+!hpo_e=bt(5w=e3(r=yige=)z$-7eccj*3z$0#4zoec'
SECRET_KEY = env.str('SECRET_KEY', UNSAFE_DEFAULT_SECRET_KEY)
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_DIR, 'pet_shelter', 'templates')
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
